package lv.cebbys.mcmods.celib.api.component.event.block;
...
import static lv.cebbys.mcmods.celib.api.component.block.CelibBlock.BRIDGE;
import static lv.cebbys.mcmods.celib.api.component.block.CelibBlock.LOGGER;
...
public interface CelibBlockServerEvents extends CelibBlockCommonEvents {
     ...
     * @param bl
     */
    default void afterBreakEvent(ServerLevel level, BlockPos pos, BlockState state, ItemStack itemStack, boolean bl) {
        LOGGER.info("[SERVER]{}.afterBreakEvent({}, {})", BRIDGE, itemStack, bl);
    }
